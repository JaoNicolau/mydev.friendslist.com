...
<script>
  ...
  .then(data => {
    let utilizadores = data.users;
    let numUsers = data.numUsers;
    console.log(data);
    console.log(utilizadores);
    console.log(numUsers);
    console.log('Número de utilizadores: ' + data.nnumUserDoPorto);
     document.getElementById('numUsers').textContent =
      `Total de utilizadores: ${utilizadores.length}`;
  })
